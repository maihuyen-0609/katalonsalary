...
WebUI.setText(findTestObject('Object Repository/Page_Permission/input_search'), 'Mina1')
...
WebUI.click(findTestObject('Object Repository/Page_Permission/button_Edit'))

WebUI.setText(findTestObject('Page_Permission/enter_Permission Name'), 'Mina2')

WebUI.click(findTestObject('Page_Permission/button_submit'))

WebUI.click(findTestObject('Object Repository/Page_Permission/noti_SuccessUpdated successfully'))

WebUI.click(findTestObject('Page_Permission/button_filter Name'))

WebUI.click(findTestObject('Page_Permission/button_Clear'))

WebUI.click(findTestObject('Object Repository/Page_Permission/button_Filter Permission name'))

WebUI.setText(findTestObject('Page_Permission/input_search'), 'Mina2')

WebUI.click(findTestObject('Object Repository/Page_Permission/button_Apply'))

WebUI.click(findTestObject('Object Repository/Page_Permission/view_Permission nameMina2'))
...
WebUI.click(findTestObject('Object Repository/Page_Permission/textfield_Mina2'))
