...
WebUI.setText(findTestObject('Object Repository/Page_Permission/input_searchper'), searchvalue)

WebUI.click(findTestObject('Object Repository/Page_Category/span_Apply'))
