...
WebUI.click(findTestObject('Object Repository/Salarysubmit/button_Basic Salary'))

WebUI.click(findTestObject('Object Repository/Salarysubmit/button_Upload Data'))

CustomKeywords.'paygroup.PayGroup.UploadFile'('D:\\USER\\Downloads\\Bảng lương team IT\\basic salary 20 user IT.xlsx')
